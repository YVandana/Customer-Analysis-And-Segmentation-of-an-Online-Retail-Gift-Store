...
"""### Notes on the Visualisation

As we can see from the graph the most actionable decisoin would be to Nurture customers since they represent the highest grouping of customers followed by retaining the customers and so on as shown in the decreasing trend.
Further trends of the Monetary, Recency and Frequency values are clear in their definition in each of the clusters.
"""